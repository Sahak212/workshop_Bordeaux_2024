...
def integral(param):
    ...
    qs_max_H2 = param[1]  # maximum substrate uptake rate of hydrogenotrophs
    Ks_H2 = param[2] # "affinity" of the hydrogenotrophs
    k_L_a = 8.33333  # units in h^-1, rate of liquid-gas transfer
    qs_max_Prop = 1.04487724e-02  # maximum substrate uptake rate of the acetate oxidizers
    Ks_Prop = 1.00001558e-02  # "affinity" of the acetate oxidizers
