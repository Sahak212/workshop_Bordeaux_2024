...
def integral(X_Prop_gX_p, qs_max_Prop_p, Ks_Prop_p, Ki_Prop_p):
    # optimizable parameters for reaction kinetics
    qs_max_H2 = 0.124505208  # maximum substrate uptake rate of hydrogenotrophs
    Ks_H2 = 1.56E-07 # "affinity" of the hydrogenotrophs
