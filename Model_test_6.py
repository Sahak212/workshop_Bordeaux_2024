...
def integral(X_H2_gX_p, qs_max_H2_p, Ks_H2_p):
    ...
    qs_max_Prop = 0.5522  # maximum substrate uptake rate of the acetate oxidizers
    Ks_Prop = 0.0001  # "affinity" of the acetate oxidizers
